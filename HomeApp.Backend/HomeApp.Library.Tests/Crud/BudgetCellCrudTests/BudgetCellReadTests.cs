namespace HomeApp.Library.Tests.Crud.BudgetCellCrudTests
{
    public class BudgetCellReadTests : BaseBudgetCellTest
    {
        ...
        public async Task FindByIdAsync_ReturnsBudgetCell_WhenExists()
        {
            ...
            // Act
            BudgetCell? result = await _budgetCellCrud.FindByIdAsync(budgetCell.Id);
        ...
        {
            // Act & Assert
            Func<Task> action = async () => await _budgetCellCrud.FindByIdAsync(id);
        ...
        {
            // Assert
            Func<Task> action = async () => await _budgetCellCrud.FindByIdAsync(999);
        ...
        public async Task GetAllAsync_ReturnsAllBudgetCells()
        {
            ...
            // Act
            IEnumerable<BudgetCell>? result = await _budgetCellCrud.GetAllAsync();
        ...
        public async Task GetAllAsync_WithUserId_ReturnsAllBudgetCells(int selectedUserId, int selectedCount)
        {
            ...
            // Act
            IEnumerable<BudgetCell>? result = await _budgetCellCrud.GetAllAsync(selectedUserId);
