...
public class BudgetCellConfiguration : IEntityTypeConfiguration<BudgetCell>
{
    public void Configure(EntityTypeBuilder<BudgetCell> builder)
    {
        ...
        builder.Property(bc => bc.BudgetRowId).IsRequired();
        builder.Property(bc => bc.BudgetColumnId).IsRequired();
        builder.Property(bc => bc.BudgetGroupId).IsRequired();
        builder.Property(bc => bc.PersonId).IsRequired();
        builder.Property(bc => bc.Year).IsRequired();
