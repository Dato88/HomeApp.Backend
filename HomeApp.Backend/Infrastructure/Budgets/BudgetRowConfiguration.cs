...
public class BudgetRowConfiguration : IEntityTypeConfiguration<BudgetRow>
{
    public void Configure(EntityTypeBuilder<BudgetRow> builder)
    {
        ...
        builder.Property(br => br.CreatedAt).HasDefaultValue(DateTime.UtcNow);

        builder.Property(br => br.PersonId).IsRequired();
        builder.Property(br => br.Index).IsRequired();
        builder.Property(br => br.Year).IsRequired();
